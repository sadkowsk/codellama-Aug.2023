...
<img width="1358" alt="Language Correlations" src="https://github.com/sadkowsk/code-llama/assets/143565317/36672b42-d8a0-4430-b3c7-d47abb44de6a">

> _“Figure 3: Correlations between Languages. Correlation scores between the Python, C++, Java, PHP, C#, TypeScript (TS), and Bash, reported for different model sizes. The code for this figure was generated by Code Llama - Instruct, the prompt and code can be seen in Figure 21.”_
