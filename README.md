...
* Code Llama models significantly outperform the Llama 2 foundation models they are based on. For example, Code Llama 7B beats Llama 2 70B on HumanEval pass@1.
*The Code Llama models surpass other publicly available models like PaLM, Codex, and GPT Neo on these benchmarks.
* There are substantial gains from scaling up model size. Code Llama 34B sets a new SOTA on MBPP among open source models.
* Specializing for Python in Code Llama-Python provides an additional boost beyond the base Code Llama models.
* Even after safety-focused instruction tuning, Code Llama-Instruct retains competitive coding performance.

<img width="1358" alt="Figure 3" src="https://github.com/sadkowsk/code-llama/assets/143565317/f900588b-90c2-426d-94c5-6b66553006a5">
...
* The visual shows Code Llama has learned generalizable coding concepts that transfer across programming languages.
